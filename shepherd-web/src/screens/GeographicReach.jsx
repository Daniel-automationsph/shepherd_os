...
import { barangays, totalBarangays, barangaysReached, geographicCoverageKpi, reachTargetPct } from '../data/mockData'
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <span
                  style={{
                    ...
                    padding: '4px 10px',
                    borderRadius: 999,
                    color: selected.reached ? 'var(--status-on-target)' : 'var(--status-critical)',
                    background: selected.reached ? 'var(--status-on-target-bg)' : 'var(--status-critical-bg)',
                  }}
                >
                  {selected.reached ? 'Reached' : 'Not Reached'}
                </span>
              </div>
            ...
            >
              <span
                style={{
                  ...
                  height: 8,
                  borderRadius: '50%',
                  background: b.reached ? 'var(--status-on-target)' : 'var(--status-critical)',
                  flexShrink: 0,
                }}
              />
